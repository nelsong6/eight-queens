  ...
  <div style={styles.container}>
    <div style={styles.inner}>
      ...
      {section === 'problem' && (
        <>
          <p style={styles.para}>
            Place 8 queens on an 8×8 chessboard so that no two queens attack one another.
      ...
      {section === 'algorithm' && (
        <>
          ...
          <Term term="Population" id="glossary-population">A set of specimens (candidate solutions). Default size: 100 (Quick Demo) or 10,000 (Standard).</Term>
          <Term term="Specimen" id="glossary-specimen">A single candidate solution — an array of 8 integers representing queen positions.</Term>
      ...
      {section === 'lifecycle' && (
        <>
          <p style={styles.para}>
            Every specimen has an age (0–3) that advances each generation.
          </p>
          <Term term="0 — Chromosome" id="glossary-age-lifecycle">Freshly created via crossover; not yet a full specimen. Awaiting fitness evaluation.</Term>
          <Term term="1 — Child">Realized specimen (fitness evaluated). Born this generation.</Term>
      ...
      {section === 'controls' && (
        <>
          ...
          <Term term="Specimen tab">Click any specimen in Granular Step to inspect their genome, parentage, and mutation history.</Term>
      ...
      {section === 'presets' && (
        <>
          <Term term="Quick Demo">100 specimens — fast to solve, good for exploring the UI.</Term>
          <Term term="Standard">10,000 specimens — realistic run, typically solves in tens of generations.</Term>
          <Term term="High Mutation">10,000 specimens, 50% mutation rate — more exploration, slower convergence.</Term>
          <Term term="Small Population">500 specimens, narrower crossover range — moderate speed and diversity.</Term>
        </>
      )}
    </div>
  </div>
